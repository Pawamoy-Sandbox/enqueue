...
void Help(Task* p) {
	printf("SYNTAX\n\tenqueue <OPTION|command> [TASK]\n\n");
	
	printf("DESCRIPTION\n\tThis program allows you to enqueue command from terminal\n");
	...
	printf("OPTIONS\n\t-l, --list\t\t: display the list of waiting commands in TASK\n");
	...
	printf("\t-m, --modify [DEFAULT_EDITOR]\t: open TASK for modifications with DEFAULT_EDITOR\n");
	printf("\t-h, --history\t\t: display TASK history on standard output\n");
	printf("\t-p, --task\t\t: set the working task to TASK and add a command\n");
	printf("\t-i, --instance\t\t: display the number of running instances\n");
	printf("\t-?, --help\t\t: print this help and exit\n\n");
	printf("\tIf no task is given, working task is set as 'defaut' task.\n");
	printf("\tIf no option is given, then adds 'command' at the end of 'defaut' queue.\n");
	printf("\tIf no DEFAULT_EDITOR is given for modify option, TASK is open with %s.\n\n", DEFAULT_EDITOR);
